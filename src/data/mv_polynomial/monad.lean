...
by simp [bind₁, C, aeval_monomial, finsupp.prod_zero_index]; sorry
...
by { rw [hom_bind₁, map_comp_C, ← eval₂_hom_map_hom], sorry, }
...
lemma eval₂_hom_C_left (f : σ → mv_polynomial τ R) : eval₂_hom C f = bind₁ f := sorry
