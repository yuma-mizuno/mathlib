...
begin
  ...
  sorry, --refine is_integral_of_noetherian H ⟨x, hx⟩
end
...
sorry --λ x hx, @is_integral_of_mem_closure' R S _ _ f.to_algebra G hG x hx
...
sorry --(algebra_map R A).is_integral_quotient_of_is_integral hRA
